defmodule SpikePapertrailWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SpikePapertrailWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SpikePapertrailWeb.Gettext, "errors", msg, opts)
    end
  end
